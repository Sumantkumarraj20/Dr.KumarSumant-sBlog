                  ...
                  <VStack spacing={6} align="stretch">
                    ...
                    <VStack spacing={4} align="stretch" pt={4}>
                      <Button
                        ...
                        _hover={{
                          transform:
                            status !== "sent" ? "translateY(-2px)" : "none",
                      ...
                      {status === "error" && (
                        <Alert status="error" rounded="lg" variant="subtle">
                          ...
                          <Box>
                            ...
                            <Text fontSize="sm">
                              Please try again later or contact us directly via
                              email.
                            </Text>
                          </Box>
                        </Alert>
                ...
                <Collapse in={!user}>
                  ...
                  >
                    <VStack spacing={3} align="start">
                      ...
                      <Text fontSize="sm" color="gray.600">
                        • Email us directly at support@yourapp.com
                        <br />
                        • Join our community forum
                        <br />• Check our FAQ section for quick answers
                      </Text>
                    </VStack>
                  </Box>
                </Collapse>
