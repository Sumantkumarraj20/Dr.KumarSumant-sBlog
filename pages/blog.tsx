...
import { Box, Heading, Text, Flex, Divider, Spinner, useColorModeValue } from "@chakra-ui/react";
...
export default function Blog({ posts, categories, currentLang }: BlogProps) {
  ...
  return (
    <Layout>
      {/* ===== HEADER ===== */}
      <Box textAlign="center" maxW="3xl" mx="auto" mt={8} mb={12}>
        ...
        return (
          <Box key={cat} mb={16}>
            <Flex align="center" mb={6} gap={2}>
              ...
              <Heading as="h2" size="lg" color={headingColor} textTransform="capitalize" letterSpacing="tight">
                {cat || "Uncategorized"}
              </Heading>
            </Flex>
      ...
      <Flex ref={ref} h={12} justify="center" align="center">
        {visibleCount < posts.length && <Spinner size="sm" color="gray.500" />}
      </Flex>
    </Layout>
  );
}
